...
export const mockEvaluationCriteria = [
  { key: 'criterion1', label: 'الترحيب والاستقبال', weight: 0.1, description: 'مستوى الترحيب بالعميل عند وصوله إلى الكشك' },
  { key: 'criterion2', label: 'المعرفة بالمنتجات', weight: 0.2, description: 'إلمام الموظف بالباقات والعروض المتاحة' },
  { key: 'criterion3', label: 'مهارات العرض والإقناع', weight: 0.2, description: 'قدرة الموظف على عرض المنتجات وإقناع العميل' },
  { key: 'criterion4', label: 'المظهر العام والنظافة', weight: 0.15, description: 'مظهر الموظف ونظافة الكشك' },
  { key: 'criterion5', label: 'سرعة الخدمة', weight: 0.15, description: 'الوقت المستغرق لإتمام المعاملة' },
  { key: 'criterion6', label: 'التعامل مع الاعتراضات', weight: 0.1, description: 'كيفية التعامل مع أسئلة واعتراضات العميل' },
  { key: 'criterion7', label: 'إتمام البيع والتوديع', weight: 0.1, description: 'إنهاء المعاملة وتوديع العميل بشكل لائق' },
]
...
export const mockVisits = [
  // Completed visits with scores
  {
    ...
    scores: { criterion1: 5, criterion2: 4, criterion3: 4, criterion4: 5, criterion5: 4, criterion6: 3, criterion7: 4 },
  ...
  },
  {
    ...
    scores: { criterion1: 3, criterion2: 5, criterion3: 5, criterion4: 4, criterion5: 3, criterion6: 4, criterion7: 5 },
  ...
  },
  {
    ...
    scores: { criterion1: 4, criterion2: 3, criterion3: 3, criterion4: 4, criterion5: 5, criterion6: 3, criterion7: 4 },
  ...
  },
  {
    ...
    scores: { criterion1: 5, criterion2: 5, criterion3: 4, criterion4: 5, criterion5: 4, criterion6: 5, criterion7: 5 },
  ...
  },
  {
    ...
    visit_date: `${twoDaysAgo}T10:00:00+03:00`,
    scores: { criterion1: 4, criterion2: 4, criterion3: 5, criterion4: 3, criterion5: 4, criterion6: 4, criterion7: 4 },
  ...
  },
  {
    ...
    scores: { criterion1: 2, criterion2: 3, criterion3: 2, criterion4: 4, criterion5: 3, criterion6: 2, criterion7: 3 },
  ...
  },
  {
    ...
    scores: { criterion1: 5, criterion2: 5, criterion3: 5, criterion4: 5, criterion5: 5, criterion6: 4, criterion7: 5 },
  ...
  },
  {
    ...
    scores: { criterion1: 4, criterion2: 4, criterion3: 3, criterion4: 5, criterion5: 4, criterion6: 4, criterion7: 4 },
  ...
  // More completed for richer stats
  {
    ...
    visit_date: `${fiveDaysAgo}T18:00:00+03:00`,
    scores: { criterion1: 4, criterion2: 4, criterion3: 4, criterion4: 4, criterion5: 3, criterion6: 4, criterion7: 4 },
  ...
  },
  {
    ...
    visit_date: `${fourDaysAgo}T10:00:00+03:00`,
    scores: { criterion1: 5, criterion2: 3, criterion3: 4, criterion4: 5, criterion5: 4, criterion6: 3, criterion7: 4 },
  ...
  },
  {
    ...
    visit_date: `${threeDaysAgo}T18:00:00+03:00`,
    scores: { criterion1: 5, criterion2: 5, criterion3: 5, criterion4: 4, criterion5: 5, criterion6: 5, criterion7: 5 },
  ...
  },
  {
    ...
    scores: { criterion1: 4, criterion2: 5, criterion3: 4, criterion4: 5, criterion5: 4, criterion6: 4, criterion7: 5 },
  ...
  },
  {
    ...
    visit_date: `${fourDaysAgo}T10:00:00+03:00`,
    scores: { criterion1: 3, criterion2: 3, criterion3: 3, criterion4: 3, criterion5: 4, criterion6: 3, criterion7: 3 },
  ...
  },
  {
    ...
    visit_date: `${twoDaysAgo}T18:00:00+03:00`,
    scores: { criterion1: 4, criterion2: 4, criterion3: 4, criterion4: 4, criterion5: 2, criterion6: 4, criterion7: 4 },
